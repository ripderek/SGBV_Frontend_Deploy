...
const data = [
  {
    ...
    value: "dashboard",
    title: "Crea proyectos y comparte recursos",
    img: "/img/Home/gdocs_edit2.gif",
    desc: `Pruedes compartir recursos de otras plataformas o subir tus propios recursos para los participantes del proyecto`,
  },
  {
              ...
              return (
                <TabPanel key={value} value={value}>
                  <div className="grid   grid-flow-col border-b-blue-gray-900 border-b-4 ">
                    <div
                      className=" cuadro row-span-3 h-80"
